...
class StoreTecnologyRequest extends FormRequest
{
    ...
    {
        return [
            'name_technologies' => ['required','min:3','max:150', Rule::unique('technologies')->ignore($this->technology)], //con ignore($this->project) non da errore se modifico solo content
    ...
    public function messages()
    {
        return [
            ...
            'name_technologies.unique' => 'Tecnologia già esistente, prova un altro nome'
